...
class AppView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body:
          navigationShell, // Seçili navigationbardan gelen konacak(path den gelen view)
      bottomNavigationBar: NavigationBarTheme(
        data: NavigationBarThemeData(
            // Navigation bar text dinamik renk değiştirmesi buradan sağlanıyor
        ...
        child: NavigationBar(
            ...
            selectedIndex: navigationShell
                .currentIndex, // aktif seçili index kısım buradan geliyor
            indicatorColor: Colors.transparent, // sanırım seçili kısım
            onDestinationSelected: navigationShell
                .goBranch, // hangisinin tıklandığını navigationshell e buradan bildiriyoruz
            destinations: [
              _menuItem(context,
